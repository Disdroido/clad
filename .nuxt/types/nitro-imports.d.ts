declare global {
  ...
  const analyzeClothingImage: typeof import('../../server/utils/openrouter').analyzeClothingImage
  ...
  const generateOutfitReasoning: typeof import('../../server/utils/openrouter').generateOutfitReasoning
  const generateValidOutfits: typeof import('../../server/utils/outfit-engine').generateValidOutfits
  const getCookie: typeof import('../../node_modules/h3').getCookie
  const getHeader: typeof import('../../node_modules/h3').getHeader
  const getHeaders: typeof import('../../node_modules/h3').getHeaders
  const getMethod: typeof import('../../node_modules/h3').getMethod
  const getOpenRouterClient: typeof import('../../server/utils/openrouter').getOpenRouterClient
